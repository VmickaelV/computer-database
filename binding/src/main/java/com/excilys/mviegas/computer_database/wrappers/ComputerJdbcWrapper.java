...
import com.excilys.mviegas.computer_database.interfaces.IConverter;
...
public enum ComputerJdbcWrapper implements IConverter<ResultSet, Computer> {
	...
	public ResultSet getAsString(Computer pValue) {
		// TODO To Implement
		throw new UnsupportedOperationException("com.excilys.mviegas.computer_database.wrappers.ComputerJdbcWrapper#getAsString not implemented yet.");
	}
